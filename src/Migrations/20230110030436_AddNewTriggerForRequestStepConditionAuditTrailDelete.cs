...
{
    public partial class AddNewTriggerForRequestStepConditionAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepConditionAuditTrailDelete] ON [dbo].[RequestStepConditions] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestStepConditionAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
