...
{
    public partial class AddNewTriggerForHolidayAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_HolidayAuditTrailInsert] ON [dbo].[Holidays] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_HolidayAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
