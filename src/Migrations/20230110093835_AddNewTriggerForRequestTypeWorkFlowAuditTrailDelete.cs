...
{
    public partial class AddNewTriggerForRequestTypeWorkFlowAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestTypeWorkFlowAuditTrailDelete] ON [dbo].[RequestTypeWorkFlows] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
            string trigger = @"Drop Trigger Trig_RequestTypeWorkFlowAuditTrailDelete";
            migrationBuilder.Sql(trigger);
        }
    }
}
