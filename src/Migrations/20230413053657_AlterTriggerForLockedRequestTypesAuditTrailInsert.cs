...
{
    public partial class AlterTriggerForLockedRequestTypesAuditTrailInsert : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_LockedRequestTypeAuditTrailInsert] ON [dbo].[LockedRequestTypes] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_LockedRequestTypeAuditTrailInsert] ON [dbo].[LockedRequestTypes] FOR INSERT
NOT FOR REPLICATION
AS
Begin
