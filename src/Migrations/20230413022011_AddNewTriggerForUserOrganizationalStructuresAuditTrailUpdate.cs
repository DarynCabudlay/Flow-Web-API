...
{
    public partial class AddNewTriggerForUserOrganizationalStructuresAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_UserOrganizationalStructureAuditTrailUpdate] ON [dbo].[UserOrganizationalStructures] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End";
        ...
        {
			string trigger = @"Drop Trigger Trig_UserOrganizationalStructureAuditTrailUpdate";
			migrationBuilder.Sql(trigger);
		}
    }
}
