...
namespace workflow.Migrations
{
    ...
    [Migration("20230320092411_ChangeCreatedByToCreatedByPK")]
    partial class ChangeCreatedByToCreatedByPK
    {
            ...
            modelBuilder.Entity("workflow.Models.ApprovalLevelDetail", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 449, DateTimeKind.Local).AddTicks(4153));
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 317, DateTimeKind.Local).AddTicks(6718));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 321, DateTimeKind.Local).AddTicks(1990));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 351, DateTimeKind.Local).AddTicks(8776));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 351, DateTimeKind.Local).AddTicks(9630));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 337, DateTimeKind.Local).AddTicks(1019));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 337, DateTimeKind.Local).AddTicks(2168));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 366, DateTimeKind.Local).AddTicks(8401));
            ...
            modelBuilder.Entity("workflow.Models.Holiday", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 433, DateTimeKind.Local).AddTicks(2575));
            ...
            modelBuilder.Entity("workflow.Models.HolidayAffectedOffice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 437, DateTimeKind.Local).AddTicks(7383));
            ...
            modelBuilder.Entity("workflow.Models.HolidayDate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 435, DateTimeKind.Local).AddTicks(5441));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 393, DateTimeKind.Local).AddTicks(1858));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 369, DateTimeKind.Local).AddTicks(6868));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 369, DateTimeKind.Local).AddTicks(7683));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 374, DateTimeKind.Local).AddTicks(6360));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 381, DateTimeKind.Local).AddTicks(189));
            ...
            modelBuilder.Entity("workflow.Models.UserOrganizationalStructure", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 17, 24, 11, 445, DateTimeKind.Local).AddTicks(126));
