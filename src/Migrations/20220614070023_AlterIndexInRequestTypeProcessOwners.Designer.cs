...
namespace workflow.Migrations
{
    ...
    [Migration("20220614070023_AlterIndexInRequestTypeProcessOwners")]
    partial class AlterIndexInRequestTypeProcessOwners
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 709, DateTimeKind.Local).AddTicks(4750));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 714, DateTimeKind.Local).AddTicks(6079));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 785, DateTimeKind.Local).AddTicks(6887));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 785, DateTimeKind.Local).AddTicks(9382));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 747, DateTimeKind.Local).AddTicks(7371));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 747, DateTimeKind.Local).AddTicks(9424));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 822, DateTimeKind.Local).AddTicks(7337));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 827, DateTimeKind.Local).AddTicks(9426));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 828, DateTimeKind.Local).AddTicks(1070));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 836, DateTimeKind.Local).AddTicks(3213));
            ...
            modelBuilder.Entity("workflow.Models.RequestForm", b =>
                {
                    ...
                    b.HasIndex("RequestCategoryId", "RequestTypeId", "Version");
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 15, 0, 22, 843, DateTimeKind.Local).AddTicks(789));
                    ...
                    b.HasKey("RequestCategoryId", "Id", "Version");
            ...
            modelBuilder.Entity("workflow.Models.RequestTypeProcessOwner", b =>
                {
                    ...
                    b.HasIndex(new[] { "RequestCategoryId", "RequestTypeId", "Version" }, "IX_RequestTypeProcessOwners_RequestCategoryId_RequestTypeId_Version");
            ...
            modelBuilder.Entity("workflow.Models.RequestForm", b =>
                {
                    ...
                    b.HasOne("workflow.Models.RequestType", "RequestType")
                        .WithMany("RequestForms")
                        .HasForeignKey("RequestCategoryId", "RequestTypeId", "Version")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
