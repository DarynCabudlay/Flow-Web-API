...
{
    public partial class AlterTriggerForRequestTypesAuditTrailInsert : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestTypeAuditTrailInsert] ON [dbo].[RequestTypes] FOR INSERT
NOT FOR REPLICATION
AS
Begin
