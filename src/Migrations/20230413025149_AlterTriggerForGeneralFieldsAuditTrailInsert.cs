...
{
    public partial class AlterTriggerForGeneralFieldsAuditTrailInsert : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_GeneralFieldsAuditTrailInsert] ON [dbo].[GeneralFields] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_GeneralFieldsAuditTrailInsert] ON [dbo].[GeneralFields] FOR INSERT
NOT FOR REPLICATION
AS
Begin
