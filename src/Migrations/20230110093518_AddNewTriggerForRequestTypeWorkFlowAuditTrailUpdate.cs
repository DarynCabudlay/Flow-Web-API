...
{
    public partial class AddNewTriggerForRequestTypeWorkFlowAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestTypeWorkFlowAuditTrailUpdate] ON [dbo].[RequestTypeWorkFlows] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestTypeWorkFlowAuditTrailUpdate";
			migrationBuilder.Sql(trigger);
		}
    }
}
