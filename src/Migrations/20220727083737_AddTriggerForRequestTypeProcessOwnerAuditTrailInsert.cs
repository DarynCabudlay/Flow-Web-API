...
{
    public partial class AddTriggerForRequestTypeProcessOwnerAuditTrailInsert : Migration
    {
...
End";
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestTypeProcessOwnersAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
