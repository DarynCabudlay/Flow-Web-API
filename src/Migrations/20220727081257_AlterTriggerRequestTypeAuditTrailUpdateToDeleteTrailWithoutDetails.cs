...
{
    public partial class AlterTriggerRequestTypeAuditTrailUpdateToDeleteTrailWithoutDetails : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestTypeAuditTrailUpdate] ON [dbo].[RequestTypes] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
