...
{
    public partial class AlterTriggerForRequestTypeProcessOwnersAuditTrailDelete : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestTypeProcessOwnersAuditTrailDelete] ON [dbo].[RequestTypeProcessOwners] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_RequestTypeProcessOwnersAuditTrailDelete] ON [dbo].[RequestTypeProcessOwners] FOR DELETE
NOT FOR REPLICATION
AS
Begin
