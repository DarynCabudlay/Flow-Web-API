...
{
    public partial class AddNewTriggerForApprovalLevelDetailsAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_ApprovalLevelDetailAuditTrailUpdate] ON [dbo].[ApprovalLevelDetails] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End";
        ...
        {
			string trigger = @"Drop Trigger Trig_ApprovalLevelDetailAuditTrailUpdate";
			migrationBuilder.Sql(trigger);
		}
    }
}
