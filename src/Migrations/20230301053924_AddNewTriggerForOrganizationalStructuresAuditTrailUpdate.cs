...
{
    public partial class AddNewTriggerForOrganizationalStructuresAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_OrganizationalStructureAuditTrailUpdate] ON [dbo].[OrganizationalStructures] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_OrganizationalStructureAuditTrailUpdate";
			migrationBuilder.Sql(trigger);
		}
    }
}
