...
namespace workflow.Migrations
{
    ...
    [Migration("20220607084828_RequestTypeRelatedTables")]
    partial class RequestTypeRelatedTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 499, DateTimeKind.Local).AddTicks(3009));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 503, DateTimeKind.Local).AddTicks(2610));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 540, DateTimeKind.Local).AddTicks(2396));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 540, DateTimeKind.Local).AddTicks(3606));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 522, DateTimeKind.Local).AddTicks(5365));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 522, DateTimeKind.Local).AddTicks(6749));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 561, DateTimeKind.Local).AddTicks(6095));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 565, DateTimeKind.Local).AddTicks(1711));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 565, DateTimeKind.Local).AddTicks(2885));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 567, DateTimeKind.Local).AddTicks(3915));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 575, DateTimeKind.Local).AddTicks(6509));
            ...
            modelBuilder.Entity("workflow.Models.RequestTypeField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("RequestTypeFieldVersionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RequestTypeFieldVersionId");

                    b.ToTable("RequestTypeFields");
                });

            modelBuilder.Entity("workflow.Models.RequestTypeFieldsLOV", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("RequestTypeFieldId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RequestTypeFieldId");

                    b.ToTable("RequestTypeFieldsLOVs");
                });

            modelBuilder.Entity("workflow.Models.RequestTypeFieldsVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 7, 16, 48, 27, 572, DateTimeKind.Local).AddTicks(7399));
                    ...
                    b.ToTable("RequestTypeFieldVersions");
                });
            ...
            modelBuilder.Entity("workflow.Models.RequestTypeField", b =>
                {
                    b.HasOne("workflow.Models.GeneralField", "GeneralField")
                        .WithMany("RequestTypeFields")
                        .HasForeignKey("GeneralFieldId");

                    b.HasOne("workflow.Models.RequestTypeFieldsVersion", "RequestTypeFieldVersion")
                        .WithMany("RequestTypeFields")
                        .HasForeignKey("RequestTypeFieldVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeneralField");

                    b.Navigation("RequestTypeFieldVersion");
                });

            modelBuilder.Entity("workflow.Models.RequestTypeFieldsLOV", b =>
                {
                    b.HasOne("workflow.Models.RequestTypeField", "RequestTypeField")
                        .WithMany("RequestTypeFieldsLOVs")
                        .HasForeignKey("RequestTypeFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RequestTypeField");
                });

            modelBuilder.Entity("workflow.Models.RequestTypeFieldsVersion", b =>
                {
                    b.HasOne("workflow.Models.RequestType", "RequestType")
                        .WithMany("RequestTypeFieldVersions")
            ...
            modelBuilder.Entity("workflow.Models.GeneralField", b =>
                {
                    b.Navigation("RequestTypeFields");
                });
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    b.Navigation("RequestTypeFieldVersions");
                });

            modelBuilder.Entity("workflow.Models.RequestTypeField", b =>
                {
                    b.Navigation("RequestTypeFieldsLOVs");
                });
