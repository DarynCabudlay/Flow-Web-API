...
namespace workflow.Migrations
{
    ...
    [Migration("20220722054835_AddTriggerForRequestTypeAuditTrailDelete")]
    partial class AddTriggerForRequestTypeAuditTrailDelete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 132, DateTimeKind.Local).AddTicks(8962));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 135, DateTimeKind.Local).AddTicks(4915));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 163, DateTimeKind.Local).AddTicks(4410));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 163, DateTimeKind.Local).AddTicks(5116));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 152, DateTimeKind.Local).AddTicks(4331));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 152, DateTimeKind.Local).AddTicks(5281));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 174, DateTimeKind.Local).AddTicks(3733));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 197, DateTimeKind.Local).AddTicks(2415));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 176, DateTimeKind.Local).AddTicks(5245));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 176, DateTimeKind.Local).AddTicks(5969));
            ...
            modelBuilder.Entity("workflow.Models.ReasonType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 180, DateTimeKind.Local).AddTicks(9676));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 22, 13, 48, 35, 185, DateTimeKind.Local).AddTicks(8102));
            ...
            modelBuilder.Entity("workflow.Models.Reason", b =>
                {
                    b.HasOne("workflow.Models.ReasonType", "ReasonType")
                        .WithMany("Reasons")
