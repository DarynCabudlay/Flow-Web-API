...
{
    public partial class AddNewTriggerForRequestStepAssigneeDetailAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepAssigneeDetailAuditTrailDelete] ON [dbo].[RequestStepAssigneeDetails] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
            string trigger = @"Drop Trigger Trig_RequestStepAssigneeDetailAuditTrailDelete";
            migrationBuilder.Sql(trigger);
        }
    }
}
