...
namespace workflow.Migrations
{
    ...
    [Migration("20220629081952_RemoveSlugInGeneralFields")]
    partial class RemoveSlugInGeneralFields
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 281, DateTimeKind.Local).AddTicks(5560));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 284, DateTimeKind.Local).AddTicks(7268));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 315, DateTimeKind.Local).AddTicks(605));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 315, DateTimeKind.Local).AddTicks(1594));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 300, DateTimeKind.Local).AddTicks(7019));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 300, DateTimeKind.Local).AddTicks(8038));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 330, DateTimeKind.Local).AddTicks(1954));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 332, DateTimeKind.Local).AddTicks(7663));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 332, DateTimeKind.Local).AddTicks(8534));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 339, DateTimeKind.Local).AddTicks(2723));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 29, 16, 19, 52, 344, DateTimeKind.Local).AddTicks(9339));
