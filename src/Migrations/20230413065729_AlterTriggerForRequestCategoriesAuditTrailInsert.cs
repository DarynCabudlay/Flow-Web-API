...
{
    public partial class AlterTriggerForRequestCategoriesAuditTrailInsert : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestCategoryAuditTrailInsert] ON [dbo].[RequestCategories] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_RequestCategoryAuditTrailInsert] ON [dbo].[RequestCategories] FOR INSERT
NOT FOR REPLICATION
AS
Begin
