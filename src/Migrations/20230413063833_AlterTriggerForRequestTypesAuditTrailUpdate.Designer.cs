...
namespace workflow.Migrations
{
    ...
    [Migration("20230413063833_AlterTriggerForRequestTypesAuditTrailUpdate")]
    partial class AlterTriggerForRequestTypesAuditTrailUpdate
    {
            ...
            modelBuilder.Entity("workflow.Models.ApprovalLevelDetail", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 121, DateTimeKind.Local).AddTicks(6516));
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 32, 990, DateTimeKind.Local).AddTicks(2721));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 32, 993, DateTimeKind.Local).AddTicks(9685));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 25, DateTimeKind.Local).AddTicks(6575));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 25, DateTimeKind.Local).AddTicks(7539));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 10, DateTimeKind.Local).AddTicks(4932));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 10, DateTimeKind.Local).AddTicks(6364));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 39, DateTimeKind.Local).AddTicks(1946));
            ...
            modelBuilder.Entity("workflow.Models.Holiday", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 105, DateTimeKind.Local).AddTicks(9843));
            ...
            modelBuilder.Entity("workflow.Models.HolidayAffectedOffice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 110, DateTimeKind.Local).AddTicks(3022));
            ...
            modelBuilder.Entity("workflow.Models.HolidayDate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 108, DateTimeKind.Local).AddTicks(1591));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 65, DateTimeKind.Local).AddTicks(7410));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 41, DateTimeKind.Local).AddTicks(7786));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 41, DateTimeKind.Local).AddTicks(8735));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 46, DateTimeKind.Local).AddTicks(8592));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 53, DateTimeKind.Local).AddTicks(1918));
            ...
            modelBuilder.Entity("workflow.Models.UserOrganizationalStructure", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 4, 13, 14, 38, 33, 117, DateTimeKind.Local).AddTicks(3998));
