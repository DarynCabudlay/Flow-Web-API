...
namespace workflow.Migrations
{
    ...
    [Migration("20220530024912_AlterColumnRoleIdInSPPermissionControls")]
    partial class AlterColumnRoleIdInSPPermissionControls
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 332, DateTimeKind.Local).AddTicks(1076));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 334, DateTimeKind.Local).AddTicks(9319));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 360, DateTimeKind.Local).AddTicks(1189));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 360, DateTimeKind.Local).AddTicks(1990));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 347, DateTimeKind.Local).AddTicks(8358));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 347, DateTimeKind.Local).AddTicks(9221));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 371, DateTimeKind.Local).AddTicks(9104));
            ...
            modelBuilder.Entity("workflow.Models.GeneralFields", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 373, DateTimeKind.Local).AddTicks(9209));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 373, DateTimeKind.Local).AddTicks(9880));
            ...
            modelBuilder.Entity("workflow.Models.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("workflow.Models.RequestFields", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("RequestVersionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("workflow.Models.RequestFieldsLOV", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RequestFieldsLOV");
                });

            modelBuilder.Entity("workflow.Models.RequestFieldsVersions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RequestFieldsVersions");
                });
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 375, DateTimeKind.Local).AddTicks(533));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 30, 10, 49, 12, 375, DateTimeKind.Local).AddTicks(1204));
            ...
            modelBuilder.Entity("workflow.Models.RequestFields", b =>
                {
                    b.HasOne("workflow.Models.GeneralFields", "GeneralField")
                        .WithMany("RequestFields")
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("workflow.Models.RequestFieldsVersions", "RequestFieldVersion")
                        .WithMany("RequestFields")
                    ...
                    b.Navigation("RequestFieldVersion");
                });

            modelBuilder.Entity("workflow.Models.RequestFieldsLOV", b =>
                {
                    b.HasOne("workflow.Models.RequestFields", "RequestField")
                        .WithMany("RequestFieldsLOV")
            ...
            modelBuilder.Entity("workflow.Models.RequestFieldsVersions", b =>
                {
                    b.HasOne("workflow.Models.Request", "Request")
