...
namespace workflow.Migrations
{
    ...
    [Migration("20221014051238_NewColumnConditionInTextInTableRequestStepConditions")]
    partial class NewColumnConditionInTextInTableRequestStepConditions
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 170, DateTimeKind.Local).AddTicks(9336));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 174, DateTimeKind.Local).AddTicks(7423));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 203, DateTimeKind.Local).AddTicks(894));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 203, DateTimeKind.Local).AddTicks(1746));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 190, DateTimeKind.Local).AddTicks(2711));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 190, DateTimeKind.Local).AddTicks(3640));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 215, DateTimeKind.Local).AddTicks(4830));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 240, DateTimeKind.Local).AddTicks(8839));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 217, DateTimeKind.Local).AddTicks(8942));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 217, DateTimeKind.Local).AddTicks(9842));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 222, DateTimeKind.Local).AddTicks(7973));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 10, 14, 13, 12, 38, 228, DateTimeKind.Local).AddTicks(6564));
