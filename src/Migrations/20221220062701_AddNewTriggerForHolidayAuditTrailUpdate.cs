...
{
    public partial class AddNewTriggerForHolidayAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_HolidayAuditTrailUpdate] ON [dbo].[Holidays] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_HolidayAuditTrailUpdate";
			migrationBuilder.Sql(trigger);
		}
    }
}
