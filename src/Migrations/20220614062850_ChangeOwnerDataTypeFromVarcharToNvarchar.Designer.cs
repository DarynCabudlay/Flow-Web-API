...
namespace workflow.Migrations
{
    ...
    [Migration("20220614062850_ChangeOwnerDataTypeFromVarcharToNvarchar")]
    partial class ChangeOwnerDataTypeFromVarcharToNvarchar
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 496, DateTimeKind.Local).AddTicks(7864));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 499, DateTimeKind.Local).AddTicks(9568));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 525, DateTimeKind.Local).AddTicks(7226));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 525, DateTimeKind.Local).AddTicks(8004));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 512, DateTimeKind.Local).AddTicks(8133));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 512, DateTimeKind.Local).AddTicks(8979));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 538, DateTimeKind.Local).AddTicks(5181));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 542, DateTimeKind.Local).AddTicks(8778));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 542, DateTimeKind.Local).AddTicks(9546));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 547, DateTimeKind.Local).AddTicks(9674));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 14, 28, 50, 552, DateTimeKind.Local).AddTicks(86));
            ...
            modelBuilder.Entity("workflow.Models.RequestTypeProcessOwner", b =>
                {
                    ...
                    b.HasKey("RequestCategoryId", "RequestTypeId", "Version");
