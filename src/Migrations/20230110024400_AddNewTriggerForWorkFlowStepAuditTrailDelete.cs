...
{
    public partial class AddNewTriggerForWorkFlowStepAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_WorkFlowStepAuditTrailDelete] ON [dbo].[WorkFlowSteps] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_WorkFlowStepAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
