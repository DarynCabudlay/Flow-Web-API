...
{
    public partial class AddNewTriggerForHolidayAffectedOfficeAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_HolidayAffectedOfficeAuditTrailDelete] ON [dbo].[HolidayAffectedOffices] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_HolidayAffectedOfficeAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
