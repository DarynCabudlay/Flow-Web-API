...
namespace workflow.Migrations
{
    ...
    [Migration("20220613072225_AdjustPrimaryKeyOnRequestTypesAndRequestForms")]
    partial class AdjustPrimaryKeyOnRequestTypesAndRequestForms
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 853, DateTimeKind.Local).AddTicks(3267));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 856, DateTimeKind.Local).AddTicks(2396));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 881, DateTimeKind.Local).AddTicks(3298));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 881, DateTimeKind.Local).AddTicks(3992));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 868, DateTimeKind.Local).AddTicks(9007));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 868, DateTimeKind.Local).AddTicks(9944));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 892, DateTimeKind.Local).AddTicks(2520));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 894, DateTimeKind.Local).AddTicks(1869));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 894, DateTimeKind.Local).AddTicks(2516));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 898, DateTimeKind.Local).AddTicks(1519));
            ...
            modelBuilder.Entity("workflow.Models.RequestForm", b =>
                {
                    ...
                    b.Property<int>("RequestTypeRequestCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RequestTypeRequestCategoryId", "RequestTypeId1", "RequestTypeVersion");
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 13, 15, 22, 24, 900, DateTimeKind.Local).AddTicks(8849));
            ...
            modelBuilder.Entity("workflow.Models.RequestForm", b =>
                {
                    ...
                    b.HasOne("workflow.Models.RequestType", "RequestType")
                        .WithMany("RequestForms")
                        .HasForeignKey("RequestTypeRequestCategoryId", "RequestTypeId1", "RequestTypeVersion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
