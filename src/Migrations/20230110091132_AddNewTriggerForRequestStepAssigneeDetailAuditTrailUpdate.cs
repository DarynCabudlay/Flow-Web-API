...
{
    public partial class AddNewTriggerForRequestStepAssigneeDetailAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepAssigneeDetailAuditTrailUpdate] ON [dbo].[RequestStepAssigneeDetails] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End
        ...
        {
            string trigger = @"Drop Trigger Trig_RequestStepAssigneeDetailAuditTrailUpdate";
            migrationBuilder.Sql(trigger);
        }
    }
}
