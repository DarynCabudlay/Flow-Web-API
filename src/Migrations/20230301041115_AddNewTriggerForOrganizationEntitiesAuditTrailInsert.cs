...
{
    public partial class AddNewTriggerForOrganizationEntitiesAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_OrganizationEntityAuditTrailInsert] ON [dbo].[OrganizationEntities] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_OrganizationEntityAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
