...
{
    public partial class AddNewTriggerForRequestStepConditionDetailAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepConditionDetailAuditTrailUpdate] ON [dbo].[RequestStepConditionDetails] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End
        ...
        {
            string trigger = @"Drop Trigger Trig_RequestStepConditionDetailAuditTrailUpdate";
            migrationBuilder.Sql(trigger);
        }
    }
}
