...
{
    public partial class AddTriggerForRequestTypeProcessOwnerAuditTrailDelete : Migration
    {
...
End";
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestTypeProcessOwnersAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
