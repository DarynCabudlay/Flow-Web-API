...
{
    public partial class AddNewTriggerForOrganizationEntitiesAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_OrganizationEntityAuditTrailDelete] ON [dbo].[OrganizationEntities] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_OrganizationEntityAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
