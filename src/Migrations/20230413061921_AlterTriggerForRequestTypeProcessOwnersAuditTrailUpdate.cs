...
{
    public partial class AlterTriggerForRequestTypeProcessOwnersAuditTrailUpdate : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestTypeProcessOwnersAuditTrailUpdate] ON [dbo].[RequestTypeProcessOwners] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
