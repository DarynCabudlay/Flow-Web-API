...
namespace workflow.Migrations
{
    ...
    [Migration("20220725013648_AddDeviceAndUsedAppInAuditTrail")]
    partial class AddDeviceAndUsedAppInAuditTrail
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 619, DateTimeKind.Local).AddTicks(3762));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 622, DateTimeKind.Local).AddTicks(4118));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 644, DateTimeKind.Local).AddTicks(7032));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 644, DateTimeKind.Local).AddTicks(7827));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 633, DateTimeKind.Local).AddTicks(6719));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 633, DateTimeKind.Local).AddTicks(7456));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 655, DateTimeKind.Local).AddTicks(1267));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 676, DateTimeKind.Local).AddTicks(6778));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 657, DateTimeKind.Local).AddTicks(3803));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 657, DateTimeKind.Local).AddTicks(4500));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 661, DateTimeKind.Local).AddTicks(8768));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 7, 25, 9, 36, 47, 666, DateTimeKind.Local).AddTicks(429));
