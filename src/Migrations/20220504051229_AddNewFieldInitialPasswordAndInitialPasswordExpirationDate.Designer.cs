...
namespace workflow.Migrations
{
    ...
    [Migration("20220504051229_AddNewFieldInitialPasswordAndInitialPasswordExpirationDate")]
    partial class AddNewFieldInitialPasswordAndInitialPasswordExpirationDate
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 758, DateTimeKind.Local).AddTicks(6572));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 761, DateTimeKind.Local).AddTicks(6711));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 784, DateTimeKind.Local).AddTicks(3815));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 784, DateTimeKind.Local).AddTicks(4632));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 773, DateTimeKind.Local).AddTicks(1629));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 773, DateTimeKind.Local).AddTicks(2423));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 795, DateTimeKind.Local).AddTicks(4621));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 797, DateTimeKind.Local).AddTicks(5993));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 797, DateTimeKind.Local).AddTicks(6754));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 798, DateTimeKind.Local).AddTicks(8196));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 5, 4, 13, 12, 28, 798, DateTimeKind.Local).AddTicks(9033));
