...
{
    public partial class AddNewTriggerForUserOrganizationalStructuresAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_UserOrganizationalStructureAuditTrailInsert] ON [dbo].[UserOrganizationalStructures] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End";
        ...
        {
			string trigger = @"Drop Trigger Trig_UserOrganizationalStructureAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
