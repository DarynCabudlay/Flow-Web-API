...
namespace workflow.Migrations
{
    ...
    [Migration("20230110091434_AddNewTriggerForRequestStepAssigneeDetailAuditTrailDelete")]
    partial class AddNewTriggerForRequestStepAssigneeDetailAuditTrailDelete
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 786, DateTimeKind.Local).AddTicks(6412));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 796, DateTimeKind.Local).AddTicks(9672));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 891, DateTimeKind.Local).AddTicks(893));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 891, DateTimeKind.Local).AddTicks(2977));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 852, DateTimeKind.Local).AddTicks(9089));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 853, DateTimeKind.Local).AddTicks(1812));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 940, DateTimeKind.Local).AddTicks(7645));
            ...
            modelBuilder.Entity("workflow.Models.Holiday", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 33, 170, DateTimeKind.Local).AddTicks(4745));
            ...
            modelBuilder.Entity("workflow.Models.HolidayAffectedOffice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 33, 184, DateTimeKind.Local).AddTicks(412));
            ...
            modelBuilder.Entity("workflow.Models.HolidayDate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 33, 176, DateTimeKind.Local).AddTicks(9541));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 33, 50, DateTimeKind.Local).AddTicks(3078));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 965, DateTimeKind.Local).AddTicks(6272));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 965, DateTimeKind.Local).AddTicks(8386));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 32, 978, DateTimeKind.Local).AddTicks(5245));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 14, 33, 7, DateTimeKind.Local).AddTicks(2354));
