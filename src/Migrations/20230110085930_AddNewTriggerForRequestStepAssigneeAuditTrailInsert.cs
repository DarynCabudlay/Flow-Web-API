...
{
    public partial class AddNewTriggerForRequestStepAssigneeAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepAssigneeAuditTrailInsert] ON [dbo].[RequestStepAssignees] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestStepAssigneeAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
