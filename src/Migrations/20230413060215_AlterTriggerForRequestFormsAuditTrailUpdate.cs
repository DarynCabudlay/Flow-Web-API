...
{
    public partial class AlterTriggerForRequestFormsAuditTrailUpdate : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestFormsAuditTrailUpdate] ON [dbo].[RequestForms] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
