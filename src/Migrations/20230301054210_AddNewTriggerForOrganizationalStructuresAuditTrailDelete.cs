...
{
    public partial class AddNewTriggerForOrganizationalStructuresAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_OrganizationalStructureAuditTrailDelete] ON [dbo].[OrganizationalStructures] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_OrganizationalStructureAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
