...
namespace workflow.Migrations
{
    ...
    [Migration("20230110090842_AddNewTriggerForRequestStepAssigneeDetailAuditTrailInsert")]
    partial class AddNewTriggerForRequestStepAssigneeDetailAuditTrailInsert
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 691, DateTimeKind.Local).AddTicks(2508));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 703, DateTimeKind.Local).AddTicks(1582));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 812, DateTimeKind.Local).AddTicks(4953));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 812, DateTimeKind.Local).AddTicks(7898));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 761, DateTimeKind.Local).AddTicks(2217));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 761, DateTimeKind.Local).AddTicks(5854));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 871, DateTimeKind.Local).AddTicks(1752));
            ...
            modelBuilder.Entity("workflow.Models.Holiday", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 41, 127, DateTimeKind.Local).AddTicks(2738));
            ...
            modelBuilder.Entity("workflow.Models.HolidayAffectedOffice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 41, 140, DateTimeKind.Local).AddTicks(724));
            ...
            modelBuilder.Entity("workflow.Models.HolidayDate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 41, 133, DateTimeKind.Local).AddTicks(4954));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 972, DateTimeKind.Local).AddTicks(8393));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 881, DateTimeKind.Local).AddTicks(2070));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 881, DateTimeKind.Local).AddTicks(4740));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 902, DateTimeKind.Local).AddTicks(883));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 1, 10, 17, 8, 40, 923, DateTimeKind.Local).AddTicks(2806));
