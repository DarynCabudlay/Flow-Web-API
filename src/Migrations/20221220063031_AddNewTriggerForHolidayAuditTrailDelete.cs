...
{
    public partial class AddNewTriggerForHolidayAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_HolidayAuditTrailDelete] ON [dbo].[Holidays] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_HolidayAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
