...
{
    public partial class AddNewTriggerForRequestStepAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepAuditTrailInsert] ON [dbo].[RequestSteps] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestStepAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
