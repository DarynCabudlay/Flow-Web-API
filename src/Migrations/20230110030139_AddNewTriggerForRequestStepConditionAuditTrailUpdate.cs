...
{
    public partial class AddNewTriggerForRequestStepConditionAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepConditionAuditTrailUpdate] ON [dbo].[RequestStepConditions] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestStepConditionAuditTrailUpdate";
			migrationBuilder.Sql(trigger);
		}
    }
}
