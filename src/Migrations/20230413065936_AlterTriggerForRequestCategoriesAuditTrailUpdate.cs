...
{
    public partial class AlterTriggerForRequestCategoriesAuditTrailUpdate : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestCategoryAuditTrailUpdate] ON [dbo].[RequestCategories] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_RequestCategoryAuditTrailUpdate] ON [dbo].[RequestCategories] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
