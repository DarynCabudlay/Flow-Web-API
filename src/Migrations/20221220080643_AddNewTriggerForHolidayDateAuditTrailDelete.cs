...
{
    public partial class AddNewTriggerForHolidayDateAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_HolidayDateAuditTrailDelete] ON [dbo].[HolidayDates] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_HolidayDateAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
