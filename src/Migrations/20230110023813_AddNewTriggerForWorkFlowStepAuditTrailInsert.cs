...
{
    public partial class AddNewTriggerForWorkFlowStepAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_WorkFlowStepAuditTrailInsert] ON [dbo].[WorkFlowSteps] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
            string trigger = @"Drop Trigger Trig_WorkFlowStepAuditTrailInsert";
            migrationBuilder.Sql(trigger);
        }
    }
}
