...
{
    public partial class AlterTriggerForLockedRequestTypesAuditTrailDelete : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_LockedRequestTypeAuditTrailDelete] ON [dbo].[LockedRequestTypes] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_RequestCategoryAuditTrailDelete] ON [dbo].[RequestCategories] FOR DELETE
NOT FOR REPLICATION
AS
Begin
	...
	SET @TableName = 'RequestCategories'
