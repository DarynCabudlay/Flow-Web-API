...
{
    public partial class AlterTriggerForGeneralFieldsAuditTrailDelete : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_GeneralFieldsAuditTrailDelete] ON [dbo].[GeneralFields] FOR DELETE
NOT FOR REPLICATION
AS
Begin
