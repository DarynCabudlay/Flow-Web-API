...
namespace workflow.Migrations
{
    ...
    [Migration("20220404014834_UpdateDateTime2ToDateTimeInUserPreferencesAndUserPasswordPolicies")]
    partial class UpdateDateTime2ToDateTimeInUserPreferencesAndUserPasswordPolicies
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 890, DateTimeKind.Local).AddTicks(5985));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 893, DateTimeKind.Local).AddTicks(7827));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 924, DateTimeKind.Local).AddTicks(4563));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 924, DateTimeKind.Local).AddTicks(5543));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 909, DateTimeKind.Local).AddTicks(4482));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 909, DateTimeKind.Local).AddTicks(5488));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 938, DateTimeKind.Local).AddTicks(7001));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 941, DateTimeKind.Local).AddTicks(2234));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 941, DateTimeKind.Local).AddTicks(3136));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 942, DateTimeKind.Local).AddTicks(6849));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 4, 4, 9, 48, 33, 942, DateTimeKind.Local).AddTicks(7703));
