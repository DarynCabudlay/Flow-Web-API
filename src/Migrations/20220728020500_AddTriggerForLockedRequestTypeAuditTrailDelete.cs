...
{
    public partial class AddTriggerForLockedRequestTypeAuditTrailDelete : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_LockedRequestTypeAuditTrailDelete] ON [dbo].[LockedRequestTypes] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
End";
        ...
        {
			string trigger = @"Drop Trigger Trig_LockedRequestTypeAuditTrailDelete";
			migrationBuilder.Sql(trigger);
		}
    }
}
