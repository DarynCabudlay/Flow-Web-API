...
{
    public partial class AddNewTriggerForHolidayDateAuditTrailUpdate : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_HolidayDateAuditTrailUpdate] ON [dbo].[HolidayDates] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_HolidayDateAuditTrailUpdate";
			migrationBuilder.Sql(trigger);
		}
    }
}
