...
{
    public partial class AddNewTriggerForApprovalLevelDetailsAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_ApprovalLevelDetailAuditTrailInsert] ON [dbo].[ApprovalLevelDetails] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End";
        ...
        {
			string trigger = @"Drop Trigger Trig_ApprovalLevelDetailAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
