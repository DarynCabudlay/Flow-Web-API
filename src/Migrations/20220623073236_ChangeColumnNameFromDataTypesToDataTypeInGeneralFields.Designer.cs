...
namespace workflow.Migrations
{
    ...
    [Migration("20220623073236_ChangeColumnNameFromDataTypesToDataTypeInGeneralFields")]
    partial class ChangeColumnNameFromDataTypesToDataTypeInGeneralFields
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 585, DateTimeKind.Local).AddTicks(3508));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 589, DateTimeKind.Local).AddTicks(9474));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 620, DateTimeKind.Local).AddTicks(4906));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 620, DateTimeKind.Local).AddTicks(5582));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 609, DateTimeKind.Local).AddTicks(120));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 609, DateTimeKind.Local).AddTicks(1069));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 630, DateTimeKind.Local).AddTicks(9963));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 633, DateTimeKind.Local).AddTicks(305));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 633, DateTimeKind.Local).AddTicks(897));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 636, DateTimeKind.Local).AddTicks(4186));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 15, 32, 36, 639, DateTimeKind.Local).AddTicks(33));
            ...
            modelBuilder.Entity("workflow.Models.RequestTypeProcessOwner", b =>
                {
                    ...
                    b.HasIndex(new[] { "RequestTypeId", "Version" }, "IX_RequestTypeProcessOwners_RequestCategoryId_RequestTypeId_Version");
