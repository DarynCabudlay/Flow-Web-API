...
{
    public partial class AddNewTriggerForRequestStepConditionDetailAuditTrailInsert : Migration
    {
...
GO
CREATE TRIGGER [dbo].[Trig_RequestStepConditionDetailAuditTrailInsert] ON [dbo].[RequestStepConditionDetails] FOR INSERT
NOT FOR REPLICATION
AS
Begin
...
End
        ...
        {
			string trigger = @"Drop Trigger Trig_RequestStepConditionDetailAuditTrailInsert";
			migrationBuilder.Sql(trigger);
		}
    }
}
