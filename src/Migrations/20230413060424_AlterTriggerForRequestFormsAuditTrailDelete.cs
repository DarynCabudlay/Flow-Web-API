...
{
    public partial class AlterTriggerForRequestFormsAuditTrailDelete : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestFormsAuditTrailDelete] ON [dbo].[RequestForms] FOR DELETE
NOT FOR REPLICATION
AS
Begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_RequestFormsAuditTrailDelete] ON [dbo].[RequestForms] FOR DELETE
NOT FOR REPLICATION
AS
Begin
