...
namespace workflow.Migrations
{
    ...
    [Migration("20230301053607_AddNewTriggerForOrganizationalStructuresAuditTrailInsert")]
    partial class AddNewTriggerForOrganizationalStructuresAuditTrailInsert
    {
            ...
            modelBuilder.Entity("workflow.Models.AspNetRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 917, DateTimeKind.Local).AddTicks(2627));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 920, DateTimeKind.Local).AddTicks(3756));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersMenu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 947, DateTimeKind.Local).AddTicks(5025));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 947, DateTimeKind.Local).AddTicks(5948));
            ...
            modelBuilder.Entity("workflow.Models.AspNetUsersProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 934, DateTimeKind.Local).AddTicks(6444));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 934, DateTimeKind.Local).AddTicks(7401));
            ...
            modelBuilder.Entity("workflow.Models.ChangeLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 958, DateTimeKind.Local).AddTicks(7667));
            ...
            modelBuilder.Entity("workflow.Models.Holiday", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 7, 16, DateTimeKind.Local).AddTicks(7167));
            ...
            modelBuilder.Entity("workflow.Models.HolidayAffectedOffice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 7, 20, DateTimeKind.Local).AddTicks(4910));
            ...
            modelBuilder.Entity("workflow.Models.HolidayDate", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 7, 18, DateTimeKind.Local).AddTicks(6290));
            ...
            modelBuilder.Entity("workflow.Models.LockedRequestType", b =>
                {
                    ...
                    b.Property<DateTime>("DateLocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 981, DateTimeKind.Local).AddTicks(7441));
            ...
            modelBuilder.Entity("workflow.Models.Options", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 960, DateTimeKind.Local).AddTicks(9835));
                    ...
                    b.Property<DateTime?>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 961, DateTimeKind.Local).AddTicks(564));
            ...
            modelBuilder.Entity("workflow.Models.RequestCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 965, DateTimeKind.Local).AddTicks(4620));
            ...
            modelBuilder.Entity("workflow.Models.RequestType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 1, 13, 36, 6, 970, DateTimeKind.Local).AddTicks(8928));
