...
{
    public partial class AlterTriggerForGeneralFieldsAuditTrailUpdate : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_GeneralFieldsAuditTrailUpdate] ON [dbo].[GeneralFields] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[Trig_GeneralFieldsAuditTrailUpdate] ON [dbo].[GeneralFields] FOR UPDATE
NOT FOR REPLICATION
AS
BEGIN
