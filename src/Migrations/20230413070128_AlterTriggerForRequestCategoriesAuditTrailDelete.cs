...
{
    public partial class AlterTriggerForRequestCategoriesAuditTrailDelete : Migration
    {
...
GO
ALTER TRIGGER [dbo].[Trig_RequestCategoryAuditTrailDelete] ON [dbo].[RequestCategories] FOR DELETE
NOT FOR REPLICATION
AS
Begin
